...
layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Div([dcc.Graph(id='Andon-quai-A'), dcc.Graph(id='Andon-quai-I')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-B'), dcc.Graph(id='Andon-quai-J')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-C'), dcc.Graph(id='Andon-quai-K')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-D'), dcc.Graph(id='Andon-quai-L')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-E'), dcc.Graph(id='Andon-quai-M')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-F'), dcc.Graph(id='Andon-quai-N')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-G'), dcc.Graph(id='Andon-quai-O')], style={'width' : '12.4%', 'display' : 'inline-block'}),
            html.Div([dcc.Graph(id='Andon-quai-H'), dcc.Graph(id='Andon-quai-Y')], style={'width' : '12.4%', 'display' : 'inline-block'})      
            ])
    ])
...
def store_data(n, secteur):
    ...
    df['DESTINATION'] = df['CONSIGNMENT'].str[7:99]
...
@callback(Output('Andon-quai-A', 'figure'),
         [Input('memory-pullflow', 'data')])
...
@callback(Output('Andon-quai-B', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-C', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-D', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-E', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-F', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-G', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-H', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-I', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-J', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-K', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-L', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-M', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-N', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-O', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
...
@callback(Output('Andon-quai-Y', 'figure'),
         [Input('memory-pullflow', 'data')])
def update_quai_a(donnees):
    # Chargement des données en mémoire
    df = pd.DataFrame.from_dict(donnees)
